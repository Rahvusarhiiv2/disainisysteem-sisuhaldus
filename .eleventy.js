...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addPairedShortcode("todo", function(content) {
    return `<div class="flex items-center p-4 my-6 border-l-2 border-green-400 bg-green-50">
      <div class="shrik-0">
  ...
  eleventyConfig.addPairedShortcode("warning", function(content) {
    return `<div class="flex items-center p-4 my-6 border-l-2 border-yellow-400 bg-yellow-50">
      <div class="shrik-0">
  ...
  eleventyConfig.addPairedShortcode("avoid", function(content) {
    return `<div class="flex items-center p-4 my-6 border-l-2 border-red-400 bg-red-50">
      <div class="shrik-0">
  ...
  eleventyConfig.addPairedShortcode("wip", function(content) { // Work in Progress indicator
    return `<div class="flex items-center rounded p-4 my-6 bg-gray-100/50 text-gray-900/50">
      <div class="shrik-0">
