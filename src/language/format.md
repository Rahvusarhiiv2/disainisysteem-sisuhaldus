...
eleventyNavigation:
  parent: Language
  key: Vormistus- ja vormindusvõtted
  order: 2
---

# Vormistus- ja vormindusvõtted

<p class="-mt-8 text-gray-300">Loetelude ja tabelite vormistus- ja vormindusvõtted</p>
...
**Mitmetasandilisi loetelusid** koostades tuleb jälgida, et ühelgi tasandil ei oleks ainult ühte jaotist. Üksik jaotis tuleb liita eelmise tasandiga või võimaluse korral moodustada vähemalt kaks jaotist. Mitmetasandilise loetelu viimase järjestusnumbri järele pannakse punkt. Kui loetelu jaotisele viidatakse tekstis, siis järjestusnumbri lõpupunkt kustub (nt {% good %}punktis 1.2.2 nimetatud teenused{% endgood %}).

{% ex %}
<p class="mt-1">1. Kopeerimisteenused</p>
<p class="ml-5">1.1. Paberkoopia</p>
<p class="ml-14">1.1.1. Paberarhivaalist või trükisest</p>
<p class="ml-14">1.1.2. Digitaalkujutisest väljatrükk</p>
<p class="ml-14">1.1.3. Koopialehe märgistamine (tembeldamine) leidandmetega</p>
...
<div class="not-prose overflow-hidden ring-1 ring-gray-200 md:rounded mb-10">
...
<div class="not-prose overflow-hidden ring-1 ring-gray-200 md:rounded mb-10 lg:w-96">
  <table class="min-w-full divide-y divide-gray-200">
    <thead class="bg-gray-50">
      <tr>
...
**Tabelipeas olev info peaks olema võimalikult lühike**, nt mitte {% bad %}*ERPLY arve number{% endbad %}, vaid {% good %}Arve{% endgood %}. Kui võimalik, esitatakse tabelipeas olevad sõnad ainsuses.
...
<div class="not-prose overflow-hidden ring-1 ring-gray-200 md:rounded mb-10 lg:w-[600px]">
  <table class="min-w-full divide-y divide-gray-200">
    <thead class="bg-gray-50">
      <tr class="divide-x divide-gray-200">
...
<div class="-mt-6 text-sm">* Rahvusarhiivi töötaja.</div>