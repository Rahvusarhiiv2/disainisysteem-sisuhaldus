...
{% icon 'andmed', '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_972_26041)">
...
<defs>
<clipPath id="clip0_972_26041">
<rect width="24" height="24" fill="white"/>
</clipPath>
</defs>
</svg>' %}

{% icon 'arhiivimoodustaja', '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{% icon 'allüksused', '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{% icon 'arhiiv', '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{% icon 'allarhiiv', '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M3 8.14846V20.4404C3 20.8203 3.15 21.1752 3.45 21.5001C3.75 21.82 4.1 21.985 4.5 21.985H13.925V20.4904H4.5V8.17346H19.5V14.8468H21V8.14846C21.235 8.11347 21.46 7.94851 21.675 7.64859C21.89 7.34866 22 7.02374 22 6.67383V3.49963C22 3.11972 21.85 2.77481 21.54 2.46488C21.23 2.15496 20.885 2 20.5 2H3.5C3.1 2 2.75 2.15496 2.45 2.46488C2.15 2.76981 2 3.11472 2 3.49963V6.67383C2 7.02374 2.11 7.34866 2.325 7.64859C2.54 7.94851 2.765 8.11347 3 8.14846ZM20.5 3.49963V6.67383H3.5V3.49963H20.5ZM15 13.4221H9V11.9225H15V13.4221ZM16.71 19.6356L15.975 22L17.94 20.6403L19.88 22L19.14 19.6356L21.085 18.011H18.72L17.94 15.6916L17.135 18.011H14.77L16.71 19.6356Z" fill="#323232"/>
</svg>' %}

{% icon 'funktsioon', '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{% icon 'allfunktsioon', '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 10.5V6.75a4.5 4.5 0 119 0v3.75M3.75 21.75h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H3.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
  </svg>' %}

{% icon 'sari', '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{% icon 'allsari', '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 5.25a3 3 0 013 3m3 0a6 6 0 01-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1121.75 8.25z" />
  </svg>' %}

{% icon 'säilik', '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{% icon 'arhivaal', '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{% icon 'allarhivaal', '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m.75 12l3 3m0 0l3-3m-3 3v-6m-1.5-9H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
  </svg>' %}

{% icon 'fail', '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{% icon 'telli', '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{% icon 'sulge arhiivipuu', '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{% icon 'ava arhiivipuu osa', '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_1376_23050)">
...
<defs>
<clipPath id="clip0_1376_23050">
<rect width="24" height="24" fill="white"/>
</clipPath>
</defs>
</svg>' %}

{% icon 'sulge arhiivipuu osa', '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_1376_21612)">
